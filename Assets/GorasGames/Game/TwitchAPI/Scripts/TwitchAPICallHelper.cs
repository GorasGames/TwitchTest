...
namespace GorasGames.Game.TwitchAPI
{
    ...
    /// </summary>
    public class TwitchAPICallHelper : Singleton<TwitchAPICallHelper>
    {
        ...
        /// </summary>
        /// <remarks>
        /// This BLOCKS the current thread till the API response has been received, so in a production environment you
        ...
        public async Task<string> CallApiAsync(string endpoint, string method = "GET", string body = "", string[] headers = null)
        {
            ...
            //_apiDatas = httpResponseContent.Result;
